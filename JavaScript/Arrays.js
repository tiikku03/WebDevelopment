...
const temperaturesInCelcious = temperaturesInFarenheit.map(temp =>  (5/9)*(temp-32) )
...
const reducedDigits = numbersReduce.reduce((accumulator, currentValue) => accumulator + currentValue, 0)
